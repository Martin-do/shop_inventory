...
PERMISSION_SECTIONS = {
    ...
    "Inventory": [
        ...
        ("receive_stock", "Create and enter stock receipts"),
        ("review_stock_receipts", "Review submitted stock receipts"),
        ("apply_stock_receipts", "Apply approved stock receipts"),
...
SENSITIVE_PERMISSIONS = {
    ...
    "delete_products", "apply_stock_receipts", "view_profit_information", "apply_stocktakes", "assign_permissions", "view_audit_history",
}
...
URL_PERMISSION_MAP = {
    ...
    "stock_receipt_create": "receive_stock", "stock_receipt_detail": "receive_stock", "stock_receipt_add_line": "receive_stock", "stock_receipt_remove_line": "receive_stock", "stock_receipt_submit": "receive_stock",
    "stock_receipt_review_line": "review_stock_receipts", "stock_receipt_apply": "apply_stock_receipts",
